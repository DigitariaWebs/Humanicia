        ...
        >
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, var(--color-brand), #0f5132)",
              }}
            >
              <div>
                <button
              ...
              <div className="text-xs lg:text-sm opacity-70">
                © {new Date().getFullYear()} Humanicia.
              </div>
            </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <option value="Activités en présence">
                      ...
                      >
                        <motion.button
                          ...
                          style={{
                            background:
                              "linear-gradient(90deg, var(--color-brand), #0f5132)",
                          }}
                        >
