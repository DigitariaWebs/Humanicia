              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3">
                  <span
                    ...
                    style={{ background: "var(--color-mint)", color: "var(--color-brand)" }}
                  >
                    Portrait d’Éric
                  </span>
                  <span className="text-sm font-semibold" style={{ color: "var(--color-cta)" }}>Le Camino</span>
                </div>
                <p style={{ color: "var(--color-text)" }}>
                  ...
                  solitaire sur le <span className="font-semibold">Chemin de Compostelle</span>, j’ai compris à quel point la solitude peut être à la fois
                  belle… et lourde à porter. Cette expérience m’a inspiré à créer <span className="font-semibold">Humanicia</span>, un service qui reconnecte les gens
                  entre eux à travers des conversations authentiques, des appels vidéo et des rencontres réelles.
                </p>
                <div className="mt-3 space-y-3" style={{ color: "var(--color-text)" }}>
                  <p>
