...
export default function VisioServiceCheckout() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await fetch("/api/checkout/services/visio", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-md mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-muted)] text-sm mt-2">
            Parce que voir un visage change tout.
          </p>
        </div>
                ...
                <label className="flex items-center space-x-3 p-3 border border-[var(--color-border)] rounded-lg cursor-pointer hover:bg-gray-50">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-[var(--color-cta)] font-semibold">25$</span>
                    </div>
                  </div>
                </label>
                ...
                <label className="flex items-center space-x-3 p-3 border border-[var(--color-border)] rounded-lg cursor-pointer hover:bg-gray-50">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-[var(--color-cta)] font-semibold">45$</span>
                    </div>
                  </div>
                </label>
              </div>
              ...
              <div className="border border-[var(--color-border)] rounded-lg p-4 bg-gray-50 mb-4">
                ...
                <div className="bg-white rounded p-3 border">
                  ...
                  <p className="text-xs text-[var(--color-muted)] mt-1">
                    Veuillez inclure votre nom et &quot;Appels visio - {prices[selectedDuration].label}&quot; dans la note.
                  </p>
                </div>
              </div>
