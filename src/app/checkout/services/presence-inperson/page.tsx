...
export default function PresenceInPersonServiceCheckout() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await fetch("/api/checkout/services/presence-inperson", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-md mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-muted)] text-sm mt-2">
            Une présence dédiée, pensée pour toi.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-[var(--color-text)]">
                <li className="flex items-start gap-3">
                  ...
                  <span>Être accompagné à un mariage ou une sortie</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Partager une marche, un café ou un repas</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Service haut de gamme sur mesure, construit avec le client selon ses besoins</span>
                </li>
              </ul>
              ...
              <div className="border border-[var(--color-border)] rounded-lg p-4 bg-gray-50 mb-4">
                ...
                <div className="bg-white rounded p-3 border">
                  ...
                  <p className="text-xs text-[var(--color-muted)] mt-1">
                    Veuillez inclure votre nom et &quot;Activités en personne&quot; dans la note.
                  </p>
                </div>
                <div className="mt-3 p-2 bg-yellow-50 border border-yellow-200 rounded">
                  <p className="text-xs text-yellow-800">
                    💡 Le tarif sera déterminé selon vos besoins spécifiques. Éric vous contactera pour discuter des détails.
                  </p>
                </div>
              </div>
