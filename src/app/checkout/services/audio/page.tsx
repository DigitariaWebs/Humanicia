...
export default function AudioServiceCheckout() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await fetch("/api/checkout/services/audio", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-md mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-muted)] text-sm mt-2">
            Une voix qui t&apos;écoute vraiment, sans jugement.
          </p>
        </div>
              ...
              <div className="border border-[var(--color-border)] rounded-lg p-4 bg-gray-50 mb-4">
                ...
                <div className="bg-white rounded p-3 border">
                  ...
                  <p className="text-xs text-[var(--color-muted)] mt-1">
                    Veuillez inclure votre nom et &quot;Appels vocaux - {prices[selectedDuration].label}&quot; dans la note.
                  </p>
                </div>
              </div>
