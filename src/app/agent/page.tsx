...
function BubbleIcon({ variant = 1 }: { variant?: 1 | 2 | 3 }) {
  ...
  if (variant === 3) {
    return (
      <svg viewBox="0 0 24 24" {...common} aria-hidden>
        <path d="M4 6.5C4 4.57 5.79 3 8 3h8c2.21 0 4 1.57 4 3.5S18.21 10 16 10H9.76L7 12.5V10H8C5.79 10 4 8.43 4 6.5z" fill="#FFD885" />
      </svg>
    );
  }
  return (
    <svg viewBox="0 0 24 24" {...common} aria-hidden>
      <path d="M12 4C7.58 4 4 6.92 4 10.5 4 12.6 5.28 14.43 7.28 15.58 7.09 16.63 6.6 17.86 5.7 19.24c2.16-.31 3.7-1.03 4.65-1.65.51.07 1.04.11 1.58.11 4.42 0 8-2.92 8-6.5S16.42 4 12 4z" fill="#FFE8A3" />
    </svg>
  );
}
...
export default function AgentPage() {
  ...
  type Profile = { id: string; img: string; name: string; role: string; bg: string };
  const PROFILES: Profile[] = [
    { id: "p1", img: "/AgentPage/ForheadMan.png", name: "John Smith", role: "Thérapeute", bg: "#F6F1B6" },
    { id: "p2", img: "/AgentPage/WhiteHairMan.png", name: "David Johnson", role: "Co-fondateur", bg: "#F9C7C9" },
    { id: "p3", img: "/AgentPage/GlassesGirl.png", name: "Mary Johnson", role: "Enseignante", bg: "#DDF5F2" },
    { id: "p4", img: "/AgentPage/ShortHairGirl.png", name: "Patricia Davis", role: "Consultante", bg: "#FAD2CF" },
  ];

	function Star({ filled = false }: { filled?: boolean }) {
		return (
			<svg viewBox="0 0 24 24" width="16" height="16" aria-hidden className="inline-block" style={{ color: filled ? "#F4B840" : "#E5E7EB" }}>
				<path fill="currentColor" d="M12 2.75l2.9 5.88 6.5.95-4.7 4.57 1.1 6.45L12 17.97 6.2 20.6l1.1-6.45-4.7-4.57 6.5-.95L12 2.75z" />
			</svg>
		);
	}
      ...
      <section className="pt-12 md:pt-20 pb-24 md:pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="relative h-[360px] md:h-[420px] lg:h-[440px]">
              {/* back photo */}
              <motion.div
              ...
              {/* front photo */}
              <motion.div
                className="absolute left-24 md:left-36 top-0 w-[72%] md:w-[64%] aspect-[4/5] rounded-xl overflow-hidden ring-1 ring-black/5 shadow-lg"
