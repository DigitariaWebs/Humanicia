    ...
    <main>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {PILLARS.map((item) => (
            <div
              ...
              style={{ borderColor: "color-mix(in oklab, var(--color-clay) 40%, white)" }}
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-base md:text-lg font-semibold" style={{ color: "var(--color-brand)" }}>
                  {item.title}
                </h3>
              </div>
              <p className="mt-3 text-[13px] md:text-sm leading-relaxed" style={{ color: "var(--color-muted)" }}>
                {item.description}
              </p>
            </div>
          ))}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 md:mt-16 lg:mt-20 mb-16 md:mb-24 lg:mb-28">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-14 items-center">
          {/* Left copy */}
          <div>
            <p className="text-sm font-semibold" style={{ color: "var(--color-cta)" }}>Humancia</p>
            <h2 className="mt-2 text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight" style={{ color: "var(--color-brand)" }}>
              Qu’est Ce Qu’on Fait ?
            </h2>
            <p className="mt-4 text-[15px] md:text-base leading-7 md:leading-8 text-justify" style={{ color: "var(--color-muted)" }}>
              Chez Humanicia, nous créons du lien humain là où il manque. Notre mission est simple : vous offrir une
              présence attentive et bienveillante, que ce soit à travers un appel vocal anonyme, une visioconférence
              conviviale ou une rencontre en personne autour d’une activité simple. Nous écoutons, nous partageons,
              nous échangeons, toujours dans un esprit d’authenticité et de respect. Parce qu’un moment de vraie
              connexion peut changer toute une journée.
            </p>
          </div>
          ...
          <motion.div
            ...
            className="relative rounded-[28px] bg-white/90 backdrop-blur shadow-xl ring-1 ring-black/5 p-5 md:p-6 overflow-hidden"
          >
            {/* Faux window chrome */}
            ...
            <div className="relative mt-2 h-[380px] md:h-[440px] lg:h-[480px]">
              ...
              <div className="absolute -left-8 -top-10 hidden md:block h-24 w-24 rounded-full opacity-60" style={{ background: "var(--color-mint)" }} />
              <div className="absolute -right-10 -bottom-12 hidden md:block h-28 w-28 rounded-full opacity-80" style={{ background: "var(--color-peach)" }} />
              <div className="absolute left-1/2 -top-4 hidden md:block h-4 w-4 rounded-full" style={{ background: "#FACC15" }} />
              ...
              <div className="absolute right-[6%] top-[10%] w-[26%] aspect-square rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.07)] ring-1 ring-black/5 bg-white">
                <Image src="/AboutPage/WhiteMan.png" alt="Interlocuteur" fill className="object-cover" sizes="240px" />
              </div>
              ...
              <div className="absolute right-[34%] top-[14%] w-[20%] aspect-square rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.07)] ring-1 ring-black/5 bg-white">
                <Image src="/AboutPage/WhiteGirl.png" alt="Interlocutrice" fill className="object-cover" sizes="200px" />
              </div>
              ...
              <div className="absolute right-[38%] top-[48%] w-[24%] aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.09)] ring-1 ring-black/5 bg-white">
                <Image src="/AboutPage/WhiteManGlasses.png" alt="Interlocuteur" fill className="object-cover" sizes="240px" />
              </div>
              ...
              <div className="absolute right-[6%] bottom-[8%] w-[34%] aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_18px_40px_rgba(0,0,0,0.1)] ring-1 ring-black/5 bg-white">
                <Image src="/AboutPage/BlackGirl.png" alt="Interlocutrice" fill className="object-cover" sizes="320px" />
              </div>
              ...
              <div className="absolute right-[30%] top-[52%] h-16 w-16 rounded-full grid place-items-center shadow-[0_12px_24px_rgba(0,0,0,0.12)] ring-1 ring-black/5 bg-white">
                <div className="h-12 w-12 rounded-full grid place-items-center" style={{ background: "linear-gradient(135deg, #FFE8D6, #FFD3BA)" }}>
                  <Hand className="h-7 w-7" style={{ color: "var(--color-cta)" }} />
                </div>
              </div>

              {/* Action buttons */}
              <div className="absolute left-[2%] md:left-[3%] bottom-[6%] flex gap-4">
                <button className="px-6 py-3 rounded-2xl text-white text-sm font-semibold shadow-[0_8px_18px_rgba(21,128,61,0.35)] inline-flex items-center gap-2" style={{ background: "var(--color-brand)" }}>
                  <Video className="h-4 w-4" />
                  Vidéo
                </button>
                <button className="px-6 py-3 rounded-2xl text-sm font-semibold shadow-sm inline-flex items-center gap-2 ring-1 ring-black/5" style={{ background: "rgba(166,193,142,0.45)", color: "#064E3B" }}>
