...
export async function sendVerificationEmail(
  ...
  try {
    ...
    const mailOptions = {
      from: `"${process.env.APP_NAME || 'Humanicia'}" <${process.env.SMTP_USER || process.env.EMAIL_USER}>`,
      to: email,
      ...
      html: `
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>Welcome to ${process.env.APP_NAME || 'Humanicia'}</h1>
            </div>
            <div class="content">
              <p>Hello ${name},</p>
              ...
              <p>Best regards,<br>The ${process.env.APP_NAME || 'Humanicia'} Team</p>
            </div>
            <div class="footer">
...
Thank you for registering with ${process.env.APP_NAME || 'Humanicia'}!
...
Best regards,
The ${process.env.APP_NAME || 'Humanicia'} Team
      `,
    };
...
export async function sendPasswordResetEmail(
  ...
  try {
    ...
    const mailOptions = {
      from: `"${process.env.APP_NAME || "Humanicia"}" <${
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <p>You have requested to reset your password for your ${
                process.env.APP_NAME || "Humanicia"
              } account.</p>
